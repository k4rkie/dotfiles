...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("swaybg -i /home/k4rkie/Pictures/Wallhaven/rain_road_tree_foggy_bush_flowers_girl_umbrela_grey_outside_mountain.jpg -m fill")
...
hl.bind(mainMod .. " + SHIFT + E", hl.dsp.exec_cmd("rofimoji --keybinding-copy Alt+Return --max-recent 3 --prompt \"Emoji\""))
